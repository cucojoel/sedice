...
<body data-spy="scroll" data-target="#chismoso">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="chismoso">
				...
				<ul class="nav navbar-nav navbar-right">
					@if (Auth::guest())
						<li><a class="login" href="javascript:void(0)">@lang('auth.login')</a></li>
						<li><a class="register" href="javascript:void(0)">@lang('auth.register')</a></li>
					@else
						<li class="dropdown">
	...
	<div class="myModal myLogin inactive">
		
			<div class="panel panel-sedice">
		<div class="panel-heading">
				<span>@lang('auth.login')</span>
				<span class="close-myModal">X</span>
				</div>

				<div class="panel-body">
					
					<form class="form-horizontal" role="form" method="POST" action="http://sedice.local/auth/login">
					@if (count($errors) > 0)
	...
	<div class="myModal myRegister inactive">
